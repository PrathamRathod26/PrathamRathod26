...
- **Education:** Bechlore in Technology in Information and Communication Technology (2022 – Present).
- **Currently Working On:**
  - A comprehensive **Hospital Management System** (focusing on End-to-End System Design).
  - A **Expense Tracking** to master multiple ways to fetch data from postgreSQL.
- **Currently Learning:** Deepening my knowledge in **Spring Boot**, and  **Angular**.
